...
import { AddToCart } from "../Services/globalService";
...
const ProductCard = React.memo(({ category, products }) => {
  ...
  const handleCart = (product) => {
    const result = AddToCart(product, inventories);
    ...
    <>
      {filteredGroceries?.length ? (
        ...
        <div className="flex justify-center w-full">
          <Message
            type="Warnings"
            icon="./svg/searchicon.svg"
            message="No results found"
            subMessage="Sorry, no results found. Keep exploring or refine your search to find what you're looking for!"
          />
        </div>
      )}
    </>
